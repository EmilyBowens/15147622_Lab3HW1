...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sendD = (Button) findViewById(R.id.noteD);
        Button sendFS = (Button) findViewById(R.id.noteFS);
        Button sendG = (Button) findViewById(R.id.noteG);
        ...
        sendD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendFloatPD("Dnote", 73.4f);

            }
        });
        sendFS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                sendFloatPD("FSHARPnote", 92.5f);
